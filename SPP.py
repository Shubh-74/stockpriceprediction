...
st.sidebar.info("Created and designed by [Shubham Nanda](https://www.linkedin.com/in/shubham-nanda-2a6842165/)")
...
def predict():
    model = st.radio('Choose a model', ['LinearRegression', 'RandomForestRegressor', 'ExtraTreesRegressor', 'KNeighborsRegressor'])
